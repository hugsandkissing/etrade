...
## 2026-08-02 22:37 UTC (6:37pm ET Sun) — futures reopen mildly green; Monday setup
Sunday-evening futures reopened GREEN but modestly: NQ=F ~28,620, ES=F
~7,551. (CAUTION: Yahoo's % vs chartPreviousClose printed +2.5% NQ / +1.2%
ES — that's a STALE prior-close reference, NOT real. Vs Friday's actual
~28,552 NQ premarket level, the true move is only ~+0.2-0.3%.) So: a mildly
green Monday setup, continuing Friday's recovery, not a big gap.
- BTC $63,387 (−0.8% via Yahoo, in $62-64k range all weekend) — NO trigger.
- No breaking weekend news on our names (NVDA/QQQ). NVDA Q2 earnings still
  AUG 26 (calendar item).
MON PLAN PREVIEW (book: 0.144 NVDA @ 208.68, 0.068 QQQ @ 696.06, $18.01
cash): HOLD into the open. The $18 reserve stays DRY unless a fresh CONFIRMED
setup appears (same 2-green-30m / higher-low bar that worked Fri — and
recall Fri's +1% gap FADED before the real midday confirmation, so a green
...
## 2026-08-11 13:56 UTC (9:56am ET Tue) — PRE-MARKET BRIEFING (late): HOLD, reserve dry
Briefing fired ~23min after the open. Overnight was quiet: BTC drifted to ~$64.1k
(−1.6% vs the ~$65.2k Fri reference, NO trigger — well under the ±5% MARA line);
index futures were mildly firm all night (NQ +0.3%) then flat at the cash open.
At the open (live 5m candles):
- **NVDA $219.32 = +0.81% vs Mon's $217.55 close, +5.1% above our $208.68 cost** —
  bouncing back from Monday's −2% rest-day fade; leadership intact, no give-back.
- **QQQ $719.91 = −0.13% vs Mon's $720.87, +3.4% above our $696.06 cost** — flat,
  holding above cost as the steady anchor.
- BTC $64,100 (no trigger). No dated news on NVDA/QQQ. NVDA earnings AUG 26 (calendar).
- Book ~$98.55 (−1.5%), a hair below Mon's close on the flat QQQ open.
PLAN — **HOLD NVDA + QQQ, NO trade. $18.01 reserve stays DRY.** Reasoning: NVDA is
bouncing back green (+0.8%), which is strength, not the based pullback the reserve
deploys into — a green rebound open is explicitly NOT a trigger. Both holdings green
vs cost; NVDA's Monday rest didn't turn into a give-back, which is the constructive
read. Watch today: (1) does the book finally CLOSE above $100 — it's ~$1.45 away, and
needs NVDA to hold its bounce AND QQQ to firm; (2) NVDA holds $217+ (Monday's low) —
a green day confirms Monday was just a one-day rest; (3) stops far (NVDA $187.81
~17% away, executes only on a hard break, verify 5m lows). Manage the exits; no
offense forced. The one milestone in reach remains the first close above $100.

## 2026-08-12 13:34 UTC (9:34am ET Wed) — PRE-MARKET BRIEFING: HOLD, reserve dry; best shot at $100 yet
Overnight the futures built the strongest green bid of the week (NQ +0.7-0.9%),
and it delivered a firm green open. BTC recovered to ~$64.0k (−1.8% vs the
~$65.2k reference, NO trigger — well under ±5%). At the open (live 5m candles):
- **NVDA $221.87 = +2.01% vs Tue's $217.50 close, +6.3% above our $208.68 cost** —
  a clean gap-up, breaking out of the three-session $217-223 chop to the upside.
- **QQQ $724.98 = +0.91% vs Tue's $718.45 close, +4.2% above our $696.06 cost** —
  green, reclaiming $720+ and leading with the firm Nasdaq.
- BTC $64,030 (no trigger). No dated news on NVDA/QQQ. NVDA earnings AUG 26 (calendar).
- **Book ~$99.26 (−0.7%), just $0.74 of position value from the $100 line** — the
  closest and highest-quality setup to finally close above breakeven in 8 sessions.
PLAN — **HOLD NVDA + QQQ, NO trade. $18.01 reserve stays DRY.** Reasoning: this is
a +2% NVDA gap-up = strength/breakout, the exact opposite of the based pullback
the reserve deploys into — chasing a gap-up is explicitly forbidden. Both holdings
green vs cost and NVDA finally breaking the chop higher. Watch today: (1) THE
milestone — does the book CLOSE above $100 for the first time? It's within a
single good hour; a green NVDA hold does it; (2) does NVDA hold $220+ (a close
above confirms the breakout, not a fakeout); (3) stops far (NVDA $187.81 ~18%
...
## 2026-08-13 21:39 UTC (Thu evening) — MILESTONE day close-out + firm futures into Fri
- Book CLOSED $100.32 today — FIRST close above $100 in 24 sessions, book now
  positive overall (+0.32%). Recovery from the −10.1% low is complete.
- After-close: NQ futures **+1.21%** (30,214) — a notably strong bid vs the usual
  flat evenings; extends today's green tape and is constructive for Friday.
  ES green too. Could carry the book further above $100 at Fri's open.
- BTC $63,400 (−2.7% vs the ~$65.2k reference, NO trigger). No position news on
  NVDA/QQQ. NVDA Q2 earnings AUG 26 (calendar) — NVDA broke out INTO it (+8.2%
  above cost), so real two-way gap risk building for the ~32% position.
...
## 2026-08-20 21:40 UTC (Thu evening) — BTC extended to ~$72.8k, futures red into Friday
- **BTC $72,774, +5.0% on the day** (vs UTC prevClose $69,289), now **~+12.5% off Tue's
  $64.7k base** — the breakout keeps extending. Over ±5% intraday but **under ±8% since the
  last note**, and the book holds **no BTC proxy** (MARA not a position) — nothing to act on,
  logged as a risk-on tell only.
- **Index futures firmly red into Friday: ES=F −0.79%, NQ=F −0.66%.** Today's cash selloff
  (S&P −0.87%, Nasdaq −1.0%) is not reversing in the evening session — Friday could open red
  for a second straight risk-off day. This is the relevant tell for the book.
- **Reserve watch:** a genuine multi-day pullback is exactly what the dry $10.08 waits for —
  BUT only if our names FLUSH and then BASE a rising higher-low. Today they just drifted in a
  tight range (no base). If Friday opens red and NVDA/QQQ carve a confirmed higher-low that
  HOLDS on real 5m volume, that's the last-$10 setup; a continued slow grind or a knife is not.
  Watch, don't pre-commit.
- Book closed **$97.47 (−2.53% overall)**, a fresh drawdown-low close but cushioned vs a −1%
...
## 2026-09-01 21:37 UTC (Tue post-close) — risk-off tone persists into the evening; HOLD, watch $215
- **Day 37 closed a broad red day.** NVDA gapped down ~2% into the $215 shelf floor, HELD it (low
  $215.73), round-tripped to $220 midday, then faded to **$217.44 (−1.4% vs Mon)**. QQQ −1.3% to $707.64.
  **Book closed $97.17 (−1.32% close-to-close, −2.8% overall)**, lagging the indexes (S&P −0.71%, Nasdaq
  −1.03%) — the mirror of Monday's outperformance; over the two days the book is ~flat vs market. 0 trades.
- **Risk-off is persisting post-close.** **BTC ~$77.1k** (−1.9% d/d, down ~$1.7k from the $78.8k baseline —
  soft but well under ±5%, no proxy, no action). **NQ=F ~−1.3%**, still soft, mirroring the day's tape. No
  dated news on NVDA/QQQ. This isn't a one-hour wobble — the weak tone carried into the evening.
- **Plan into Wednesday: HOLD both, no powder (cash $0.17) — HOLD or trim only.** The key level is the
  **$215 shelf**, which HELD on a real test today: NVDA ≥$215 = digestion intact (reclaiming $220 reopens
  the $228 high); a decisive break below $215 on volume = digestion extends toward the $208-210 lower gap
...
## 2026-09-04 21:37 UTC (Fri post-close) — weekend baseline; week closed at a fresh high, HOLD
- **Week (Day 36-40) closed green at a fresh high.** Book **$100.51 (+0.5% overall)** — the entire two-day
  drawdown recovered and then some. Fri was the divergent-day payoff: NVDA held its $230 breakout (spiked
  to $234.49, faded to $230.36 close, +0.84% c/c) while the broad market slipped red (S&P −0.38%, Nasdaq
  −0.29%) — book beat both indexes by ~0.8pp. 0 trades on the day/week beyond Mon's reserve deploy.
- **Weekend baseline.** **BTC ~$79.8k (−1.8%)** — eased off the week's $81.8k spike but still above the
  $77-78k base it held all week; no proxy in the book, no action, well under ±8%. Index futures closed for
  the weekend (reopen Sun ~22:00 UTC). No dated hard catalyst on NVDA/QQQ into the weekend.
- **Plan into Monday: HOLD both, fully invested (cash $0.17) — HOLD or trim only.** Book is ~43% NVDA /
  57% QQQ. NVDA is basing in the $230-234 zone after clearing the $228 post-earnings high. Key levels:
  **$234** (Fri spike high / extension ceiling — reclaim and hold = the delayed blue-sky leg) and **$230**
  (breakout, now confirmed support — held twice Fri). A decisive loss of $230 rebases toward the $228/$220
